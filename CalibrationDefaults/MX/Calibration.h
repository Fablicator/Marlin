...
#define TEMP_SENSOR_BED 1000          // Defines what thermistor we are using on the bed (17 for the green thermistor, 16 for the new blue thermistor)
