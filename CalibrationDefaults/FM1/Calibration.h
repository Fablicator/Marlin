...
#define Z_MAX_POS 193.05            // Decrease this value if first layer is too close to the print bed.
...
#define X1_BED_OFFSET   18     // Distance between left extruder tip and left side of bed when it's at the home position
...
#define TEMP_SENSOR_BED 17          // Defines what thermistor we are using on the bed (17 for the green thermistor, 16 for the new blue thermistor)
