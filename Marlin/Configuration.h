...
#define TEMP_RESIDENCY_TIME 00  // (seconds)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 350, 200, 20 }
 ...
 */
  ...
  #define DEFAULT_MAX_ACCELERATION      { 2500,2100,200,10000 }
#endif
 ...
 */
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 70), (Y_MAX_POS - 10), 80 }
