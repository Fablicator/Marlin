 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 1000//2     // Degrees Celsius
  ...
  #define WATCH_TEMP_INCREASE 0//2               // Degrees Celsius
#endif
 ...
 */
  ...
  #define WATCH_BED_TEMP_INCREASE 0.1               // Degrees Celsius
#endif
 ...
 */
  ...
  #define X1_MAX_POS X_MAX_POS - (MIN_EXTRUDER_DISTANCE/2.0) // set maximum to ensure first x-carriage doesn't hit the parked second X-carriage
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET 177
...
// #define HOMING_BACKOFF_MM { 0, 0, 0.5 }  // (mm) Move away from the endstops after homing
 ...
 */
  ...
  // Z raise distance for tool-change, as needed for some extruders
    ...
    //#define EVENT_GCODE_AFTER_TOOLCHANGE ""   // G-code to run after tool-change is complete
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     18  // (mm) Slow length, to allow time to insert material.
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY        10  // (ms) Delay for the filament to cool after retract.
